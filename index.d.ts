...
import mimeType = require('mime');

declare namespace NodeStatic {
  var version: number[];
  var mime: typeof mimeType.Mime;

  class Server {
    constructor(path?: string, options?: ServerOptions);

    server(request: ServerRequest, response: ServerResponse, cb?: (err: Error, result: any) => void): void;
